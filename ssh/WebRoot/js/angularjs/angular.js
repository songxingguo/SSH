...
function Browser(window, document, $log, $sniffer) {
  ...
  var lastBrowserUrl = location.href,
      baseElement = document.find('base-app'),
      newLocation = null;
   ...
   *
   * @description
   * Returns current <base-app href>
   * (always relative - without domain)
   *
   * @returns {string} The current base-app href
   */
 ...
 *
 * @constructor
 * @param {string} appBase application base-app URL
 ...
 * It also serves as the base-app class for html5 mode fallback on legacy browsers.
 *
 * @constructor
 * @param {string} appBase application base-app URL
...
LocationHashbangInHtml5Url.prototype =
   ...
   *
   * @param {string=} url New url without base-app prefix (e.g. `/path?a=b#hash`)
...
function $LocationProvider(){
  ...
  this.$get = ['$rootScope', '$browser', '$sniffer', '$rootElement',
    ...
    var $location,
        LocationMode,
        baseHref = $browser.baseHref(), // if base-app[href] is undefined, it defaults to ''
...
Parser.prototype = {
  ...
  statements: function() {
    ...
    while (true) {
      ...
      if (!this.expect(';')) {
        // optimize for the common-app case where there is only one statement.
            ...
            if ((watchers = current.$$watchers)) {
              ...
              while (length--) {
                try {
                  ...
                  // Most common-app watches are on primitives, in which case we can short
   ...
   <example module="ngAnimate" deps="angular-animate.js" animations="true">
     ...
     <file name="protractor.js" type="protractor">
       it('should check ng-class', function() {
         expect(element(by.css(base-app)).getAttribute('class')).not.
           toMatch(/my-class/);

         element(by.id('setbtn')).click();

         expect(element(by.css(base-app)).getAttribute('class')).
           toMatch(/my-class/);
