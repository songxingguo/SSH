	...
	<div class="container mt30" ng-controller="studentController">
	  <div class="row wp60">
		 <div class="panel panel-default">
		  <div class="panel-heading">学生信息-新增</div>
		  <div class="panel-body">
			<div class="container mt20 w bc">	   
				<form class="form-horizontal" action="stuAdd.action">
				  <div class="form-group">
				    <label for="clas" class="col-sm-2 control-label">班级</label>
				    <div class="col-sm-9">
			     		<s:select cssClass="form-control" 
						  list="clas" listKey="cid" listValue="cNo" name="cid"/>
				    </div>
				  </div> 
				  <div class="form-group">
				    <label for="stuNo" class="col-sm-2 control-label">学号</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="stuNo" name="stuNo" placeholder="学号">
				    </div>
				  </div>
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="stuAge" name="stuAge" placeholder="年龄">
				    </div>
				  </div>
